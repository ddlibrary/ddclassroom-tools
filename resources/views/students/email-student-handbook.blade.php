    ...
    <div class="container">
        <div id="container" dir="rtl">
            ...
            <table class="table table-bordered border-dark">
                ...
                <tr>
                    <td>جوابات فعالیت‌ها، ارزیابی‌‌ها و کارخانگی‌ها را چه وقت انجام دهیم؟</td>
                ...
                <tr>
                    <td>جوابات فعالیت‌ها، ارزیابی‌ها و کارخانگی را چه قسم با استاد شریک بسازیم؟</td>
            ...
            <div>
                ...
                <div>
                    ...
                    <p>
                        <span class="text-danger">a)</span> برای دانلود کردن کورس ها در صفحه کورس بالای شکل ابر کلیک
                        کنید.
                    </p>
                    <img src="{{ asset('handbook-images/4.png') }}" class="w-100">
                    <br>
                    <br>
                    <p><span class="text-danger">b)</span> در صفحه دانلود روبروی هر درس شکل ابر (آیکن دانلود) وجود دارد،
                        بالای آن کلیک کنید و صبر کنید تا
