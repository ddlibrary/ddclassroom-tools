        ...
        <div class="py-4 bg-sky-30 rounded-lg border">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class=" overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <h2 class="text-base font-semibold leading-7 text-gray-900">Create students

                        <a
                            href="/assets/samples/student-registration-format.xlsx">
                            <button
...
<script setup>
    ...
    const props = defineProps(['grades', 'errors', 'years']);
    ...
    function submit() {
        router.post(route(`students.store-multiple-student`), form, {
            forceFormData: true,
            onFinish: (res) => {
    ...
    function downloadSample() {
        router.post(route(`student-uploading-sample-file`), {
            responseType: 'blob'
        }, {
            forceFormData: true,
            onFinish: (response) => {
                ...
                'student-uploading-sample-file.xlsx'); // Set the desired file name
